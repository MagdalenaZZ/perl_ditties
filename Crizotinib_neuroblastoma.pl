...
$params{email} = "magdalena.z@icr.ac.uk";
$params{db} = "pcassay";
$params{tool} = "ebot";
$params{term} = "Crizotinib+AND+neuroblastoma";
%params = esearch(%params);

$params{linkname} = "pcassay_protein_target";
%params = elink_by_id_to('protein', %params);

$params{linkname} = "protein_protein_uniprot2refseq";
%params = elink_by_id_to('protein', %params);

$params{retmode} = "xml";
$params{outfile} = "Crizotinib_neuroblastoma.txt";
