...
Usage: qc_mapping.pl trim-start1 trim-start2  <reference genome> gff file.fastq (file2.fastq)
...
#	print OUT "tophat2 --library-type $lib -p 8 --un-gz $prefix.un.gz -i 30 -o  $prefix.TH2s $ref $prefix.NNNNN\n";
#	print OUT "date\n";
...
#	print OUT "tophat2 --library-type $lib -p 8 -r $matedist --mate-std-dev $matedev -i 30 -o $prefix.TH2p $ref $prefix.OVL.notCombined_1.fastq.gz $prefix.OVL.notCombined_2.fastq.gz \n";
