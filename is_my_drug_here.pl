#!/usr/bin/perl -w
# Stratify drug evidence
# magdalena.z@icr.ac.uk 2 April 2018
# more info 
#
...
unless (@ARGV == 1) {
	print "Usage: is_my_drug_here.pl drug \n\n" ;

    print " mz3 script for creating drug stratification\n\n";
...
#my $gene="MYCN";
my $in=shift;
my $jasfol="/Users/mzarowiecki/SMPaeds_resources";

open (OUT, ">$gene.drug.res") || die "I can't open $gene.drug.res\n";


# Get a drug synonym list for my drug
...
# Get the results for each database
...
# Elisa
	...
	# https://clinicaltrials.gov/ct2/show/NCT03184168
...
# https://bnfc.nice.org.uk/#Search?q=Lorlatinib	
...
# https://bnf.nice.org.uk/#Search?q=Lorlatinib	
...
# Lorlatinib anywhere
# https://clinicaltrials.gov/ct2/results?cond=&term=Lorlatinib&cntry=&state=&city=&dist=

# Lorlatinib in UK
# https://clinicaltrials.gov/ct2/results?term=Lorlatinib&cntry=GB&Search=Clear&age_v=&gndr=&type=&rslt=

# Lorlatinib in UK children
# https://clinicaltrials.gov/ct2/results?term=Lorlatinib&cntry=GB&Search=Apply&age_v=&age=0&gndr=&type=&rslt= 

# By topic - which disease
# https://clinicaltrials.gov/ct2/results/browse?cond=&term=Lorlatinib&cntry=&state=&city=&dist=&Search=Search&brwse=cond_alpha_all	
...
# Get data
# 		try{ 
#			system("wget -O AZD5363.html https://www.medicines.org.uk/emc/search?q=AZD5363");
#			push(@csvs,"$gene.$aid.csv");
#		}

# Filter data does not exist
# grep -rn 'Your search did not find any results' *.html
...
#Cochrane reviews
#http://www.cochrane.org/search/site/olaparib?f%5B0%5D=bundle%3Areview
