...
If log2-values, those are reversed before merging

Warning! Script does not work on matrix of values, only lists of single values:
226609_at	1.58899578763317
232752_at	1.0829069266058
210221_at	-1.02761316516655
