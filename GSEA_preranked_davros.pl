...
Then: 
perl GSEA_preranked.pl 1000 logfclist.4gsea ~/scratch/REFERENCES/msigdb.v6.0.symbols.gmt n &
...
my $rosetta = "/home/breakthr/mzarowiecki/scratch/REFERENCES/GSEA/ENSMUSG_2_humSym.chip";
...
print "\n\nExcluded $count genes from rnk file\n";
...
print "\njava -Xmx2048m  -cp ~/bin/gsea2-2.2.4.jar xtools.gsea.GseaPreranked -gmx $gs -collapse false -mode Max_probe -norm meandiv -nperm $n -rnk $rank -scoring_scheme weighted -rpt_label my_analysis -chip /home/breakthr/mzarowiecki/REF/GSEA/GENE_SYMBOL.chip -include_only_symbols true -make_sets true -plot_top_x 4726 -rnd_seed timestamp -set_max 5000 -set_min 4 -zip_report false -out $rank\_OUT -gui false > $rank.err \n\n";
